        ...
        <div class="col-md-10 col-sm-offset-1">
            ...
            <div class="box box-primary direct-chat direct-chat-primary">
              ...
              <div class="box-body" >
                ...
                <div class="direct-chat-messages" style="height:500px;">
                  ...
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-info clearfix">
                      <span class="direct-chat-name pull-right">{{ $chat->patient->name }}</span>
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                        <a href="{{ route('doctor.chat',$patient->id) }}">
                          <img class="contacts-list-img" src="{{ asset('assets/images/noimage.jpg') }}" alt="User Image">
    
                          <div class="contacts-list-info">
                                <span class="contacts-list-name">
                                {{ $patient->name }}
                                <small class="contacts-list-date pull-right">{{ $patient->patient_no }}</small>
              ...
              <div class="box-footer">
                <form action="{{ route('doctor.chat.save') }}" method="post">
                    @csrf
